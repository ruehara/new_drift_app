...
import 'package:new_app_drift/src/database/tables/teste.drift.dart' as i1;
...
typedef $TesteInsertCompanionBuilder = i1.TesteCompanion Function({
  i0.Value<int> id,
  i0.Value<String?> teste,
  i0.Value<String?> teste2,
  i0.Value<String?> teste3,
...
typedef $TesteUpdateCompanionBuilder = i1.TesteCompanion Function({
  i0.Value<int> id,
  i0.Value<String?> teste,
  i0.Value<String?> teste2,
  i0.Value<String?> teste3,
...
class $TesteTableManager extends i0.RootTableManager<
    i0.GeneratedDatabase,
    i1.Teste,
    i1.TesteData,
    i1.$TesteFilterComposer,
    i1.$TesteOrderingComposer,
    $TesteProcessedTableManager,
    $TesteInsertCompanionBuilder,
    $TesteUpdateCompanionBuilder> {
  $TesteTableManager(i0.GeneratedDatabase db, i1.Teste table)
      : super(i0.TableManagerState(
          db: db,
          table: table,
          filteringComposer:
              i1.$TesteFilterComposer(i0.ComposerState(db, table)),
          orderingComposer:
              i1.$TesteOrderingComposer(i0.ComposerState(db, table)),
          getChildManagerBuilder: (p) => $TesteProcessedTableManager(p),
...
class $TesteProcessedTableManager extends i0.ProcessedTableManager<
    i0.GeneratedDatabase,
    i1.Teste,
    i1.TesteData,
    i1.$TesteFilterComposer,
    ...
    $TesteInsertCompanionBuilder,
    $TesteUpdateCompanionBuilder> {
  $TesteProcessedTableManager(super.$state);
}

class $TesteFilterComposer
    extends i0.FilterComposer<i0.GeneratedDatabase, i1.Teste> {
  $TesteFilterComposer(super.$state);
  i0.ColumnFilters<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));

  i0.ColumnFilters<String> get teste => $state.composableBuilder(
      column: $state.table.teste,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));

  i0.ColumnFilters<String> get teste2 => $state.composableBuilder(
      column: $state.table.teste2,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));

  i0.ColumnFilters<String> get teste3 => $state.composableBuilder(
      column: $state.table.teste3,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));

  i0.ColumnFilters<String> get teste4 => $state.composableBuilder(
      column: $state.table.teste4,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));

  i0.ColumnFilters<String> get teste5 => $state.composableBuilder(
      column: $state.table.teste5,
      builder: (column, joinBuilders) =>
          i0.ColumnFilters(column, joinBuilders: joinBuilders));
...
class $TesteOrderingComposer
    extends i0.OrderingComposer<i0.GeneratedDatabase, i1.Teste> {
  $TesteOrderingComposer(super.$state);
  i0.ColumnOrderings<int> get id => $state.composableBuilder(
      column: $state.table.id,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));

  i0.ColumnOrderings<String> get teste => $state.composableBuilder(
      column: $state.table.teste,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));

  i0.ColumnOrderings<String> get teste2 => $state.composableBuilder(
      column: $state.table.teste2,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));

  i0.ColumnOrderings<String> get teste3 => $state.composableBuilder(
      column: $state.table.teste3,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));

  i0.ColumnOrderings<String> get teste4 => $state.composableBuilder(
      column: $state.table.teste4,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));

  i0.ColumnOrderings<String> get teste5 => $state.composableBuilder(
      column: $state.table.teste5,
      builder: (column, joinBuilders) =>
          i0.ColumnOrderings(column, joinBuilders: joinBuilders));
